...
def extract_regulatory_genes():
	...
	for key, value in dict_RegulGenes.items():
		# the regulatory genes is the list 'value' corresponding to each key (gene).
	...
	writer = ExcelWriter('./2_Regulatory_Genes/Full TFs - RegulatoryGenes SUMMARY Table.xlsx')
