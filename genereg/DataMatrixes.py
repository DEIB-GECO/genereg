...
def create_m1():
	...
	expr_interest_df = pd.read_excel('./3_TCGA_Data/Gene_Expression/Gene Expression - InterestGenes.xlsx',sheetname='Sheet1',header=0)
	...
	for g in multiple_pathway_genes:
		...
		for p in pathways:
			...
			writer = ExcelWriter('./4_Data_Matrix_Construction/Model1/Gene '+gene_ID+' ['+g+'] ('+p+') - Model_v1.xlsx')
...
def create_m2():
	...
	expr_regulatory_df = pd.read_excel('./3_TCGA_Data/Gene_Expression/Gene Expression - RegulatoryGenes.xlsx',sheetname='Sheet1',header=0)
	...
	for g in multiple_pathway_genes:
		...
		for p in pathways:
			...
			current_pathway_model = pd.read_excel('./4_Data_Matrix_Construction/Model1/Gene '+gene_ID+' ['+g+'] ('+p+') - Model_v1.xlsx',sheetname='Sheet1',header=0)
			...
			writer = ExcelWriter('./4_Data_Matrix_Construction/Model2/Gene '+gene_ID+' ['+g+'] ('+p+') - Model_v2.xlsx')
...
def create_m3():
	...
	for g in multiple_pathway_genes:
		...
		for p in pathways:
			...
			writer = ExcelWriter('./4_Data_Matrix_Construction/Model3/Gene '+gene_ID+' ['+g+'] ('+p+') - Model_v3.xlsx')
...
def create_m5():
	...
	for g in multiple_pathway_genes:
		...
		for p in pathways:
			...
			writer = ExcelWriter('./4_Data_Matrix_Construction/Model5/Gene '+gene_ID+' ['+g+'] ('+p+') - Model_v5.xlsx')
