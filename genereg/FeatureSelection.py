	...
	if (type == 'ffs_default') or (type == 'ffs_no_reval') or (type == 'all'):
		...
		for current_gene in SYMs_current_pathway:
			...
			if (type == 'ffs_default') and ((model == '3') or (model == '5')):
				...
				text_file = open('./5_Data_Analysis/'+gene_set+'/FeatureSelection/M'+previous_model+'/Features - Gene '+gene_ID+' ['+current_gene+'].txt', 'r')
		...
		writer = ExcelWriter('./5_Data_Analysis/'+gene_set+'/FeatureSelection/M'+model+'/Feature Selection SUMMARY.xlsx')
