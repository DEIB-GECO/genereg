...
============================================
The second data extraction phase consists in extracting from TCGA data related to the cancer type under analysis: in particular, for each target gene its methylation level (expressed as the **mean** of its *beta_values*) and its gene expression are retrieved.
