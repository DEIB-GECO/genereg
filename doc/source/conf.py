...
htmlhelp_basename = 'genexpreg_cancerdoc'
...
man_pages = [
    (master_doc, 'genexpreg_cancer', 'genexpreg_cancer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'genexpreg_cancer', 'genexpreg_cancer Documentation',
     author, 'genexpreg_cancer', 'One line description of project.',
     'Miscellaneous'),
]
