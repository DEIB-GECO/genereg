...
============================================
Extracted data are organized in order to let them be used as input for the data analysis, such that you can analyze the single regulation system of each target gene, by identifying the role of its possible regulatory features quantified as for their impact on the target expression, whatever the feature is, i.e. the gene methylaiton, the expression of a gene in the same pathway or in another pathway and the expression of genes encoding for transcription factors.
...
Here is the set of fuctions used to build the five data matrixes:
